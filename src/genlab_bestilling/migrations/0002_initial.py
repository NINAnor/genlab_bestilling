    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(help_text="When you need to get the results"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pre_isolated",
                    models.BooleanField(verbose_name="Are samples already isolated?"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("sample", "order", "marker"), name="unique_sample_per_analysis"
            ),
        ),
        migrations.AddConstraint(
            model_name="sample",
